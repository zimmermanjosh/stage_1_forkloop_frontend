        ...
        <div className="test-results">
          ...
          <div className="results-summary">
            {Array.isArray(results) ? (
              <div>
                <p><strong>Found {results.length} recipes:</strong></p>
                {results.map((recipe, index) => (
                  <div key={recipe.id || index} className="recipe-summary">
                    ...
                    <p>Cook Time: {recipe.readyInMinutes || recipe.cookingTime} min</p>
              ...
              <div className="single-recipe">
                ...
                {results.image && <img src={results.image} alt={results.title} width="200" />}
                {results.summary && (
                  <div>
                    <strong>Summary:</strong>
                    <div dangerouslySetInnerHTML={{ __html: results.summary.slice(0, 200) + '...' }} />
                  </div>
                )}
              </div>
            )}
