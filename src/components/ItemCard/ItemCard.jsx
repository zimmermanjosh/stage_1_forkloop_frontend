...
const ItemCard = ({ item, onSelectedCard, onCardLike }) => {
  ...
  return (
    <div className="card recipe-card">
      <div className="card__image-container" onClick={() => onSelectedCard(item)}>
        <img
          alt={recipeTitle}
          src={recipeImage}
        ...
        />
        {item.difficulty && (
          <div className={`card__difficulty card__difficulty--${item.difficulty}`}>
            {item.difficulty}
          </div>
        )}
      </div>
      ...
      <div className="card__content">
        ...
        {(item.glutenFree || item.dairyFree || item.vegetarian) && (
          <div className="card__tags">
            {item.glutenFree && <span className="card__tag card__tag--gf">GF</span>}
            {item.dairyFree && <span className="card__tag card__tag--df">DF</span>}
            {item.vegetarian && <span className="card__tag card__tag--v">V</span>}
